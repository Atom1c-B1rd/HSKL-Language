...
{-|
Module      : Paths_OnlyLib_Parser_HTML
...
-- at runtime using the environment variable OnlyLib_Parser_HTML_bindir.
...
-- environment variable OnlyLib_Parser_HTML_libdir.
...
-- using the environment variable OnlyLib_Parser_HTML_dynlibdir.
...
-- runtime using the environment variable OnlyLib_Parser_HTML_datadir.
...
-- variable OnlyLib_Parser_HTML_libexedir.
...
-- using the environment variable OnlyLib_Parser_HTML_sysconfdir.
...
libdir     = "/root/.cabal/lib/x86_64-linux-ghc-9.14.1-e4ac/OnlyLib-Parser-HTML-0.1.0.0-inplace-OnlyLib-Parser-HTML-test"
dynlibdir  = "/root/.cabal/lib/x86_64-linux-ghc-9.14.1-e4ac"
datadir    = "/root/.cabal/share/x86_64-linux-ghc-9.14.1-e4ac/OnlyLib-Parser-HTML-0.1.0.0"
libexecdir = "/root/.cabal/libexec/x86_64-linux-ghc-9.14.1-e4ac/OnlyLib-Parser-HTML-0.1.0.0"
sysconfdir = "/root/.cabal/etc"

getBinDir     = catchIO (getEnv "OnlyLib_Parser_HTML_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "OnlyLib_Parser_HTML_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "OnlyLib_Parser_HTML_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "OnlyLib_Parser_HTML_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "OnlyLib_Parser_HTML_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "OnlyLib_Parser_HTML_sysconfdir") (\_ -> return sysconfdir)
